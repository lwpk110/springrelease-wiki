...
== New and Noteworthy
TIP: 参阅 <<Spring-Boot-2.1-Configuration-Changelog#v2.1-configuration-changelog, Configuration properties change between `2.0.6.BUILD-SNAPSHOT` and `2.1.0.BUILD-SNAPSHOT`>> 查看有关配置更改的完整概述。