...
TIP: 参阅 <<Spring-Boot-2.5-Configuration-Changelog#v2.5-configuration-changelog, Configuration properties change between `2.2.7.RELEASE` and `2.3.0.RELEASE`>> 查看有关配置更改的完整概述。