...
TIP: 参阅 <<Spring-Boot-2.3.0-Configuration-Changelog#v2.3-configuration-changelog, Configuration properties change between `2.3.6.RELEASE` and `2.4.0`>> 查看有关配置更改的完整概述。
